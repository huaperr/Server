...
{
    const string databaseName = "Duckgame.db";
    const int port = 3306;
    const string uID = "root";
    const string password = "";
    string connectionString = $"Server=127.0.0.1 ;Port={3306};database={databaseName};uID={uID};password={password};SSL Mode=None;connect timeout = 3600;";
